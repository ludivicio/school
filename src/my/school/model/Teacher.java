...
public class Teacher extends Model<Teacher> {
	...
	public Teacher getRegister(String userId, String doctorId, String date) {
		return dao
				.findFirst(
	...
	public Page<Teacher> paginateSig(int pageNumber, int pageSize,
			String userId) {
		return dao.paginate(pageNumber, pageSize, "select *",
				"from register where userId = ? ", userId);
	}

	public Page<Teacher> paginateForDoctor(int pageNumber, int pageSize,
